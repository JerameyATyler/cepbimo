...
class DataGenerator:
    ...
    def generate_sample_recipe(self):
        from utils.data_loader import list_anechoic_lengths
        import hashlib
    ...
    def generate_sample(self, recipe):
        from utils.audio_processing import mix_parts, apply_hrtf, mix_reflections, apply_reverberation, sum_signals, \
            adjust_signal_to_noise
        from utils.figures import plot_sample, plot_wave, plot_waves, plot_binaural_activity_map_3d, \
            plot_binaural_activity_map_2d
        import numpy as np
        from utils.utils import split_channels
        from transforms.spectrum import cepstrum
        from transforms.Cepbimo import Cepbimo
        from utils.utils import generate_impulse
        from pathlib import Path
